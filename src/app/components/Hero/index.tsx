  ...
  return (
    <div className="hero relative overflow-hidden px-5">
      <motion.div variants={textVariants} initial='initial' animate='animate' className="wrapper h-full max-w-[1500px] mx-auto">
        <motion.div variants={textVariants} className="textContainer w-2/5 h-full flex justify-center flex-col gap-4  relative z-10">
          <motion.span variants={textVariants} className="uppercase text-purple-800 text-2xl tracking-widest font-semibold">Mustak sk</motion.span>
          <motion.h1 variants={textVariants} className="text-[5rem] font-semibold leading-tight">Full stack web Developer</motion.h1>
      ...
      <motion.div variants={textSliderVarients} initial='initial' animate='animate' className="slidingTextContainer absolute  text-[50vh] -bottom-[120px] whitespace-nowrap text-[#ffffff09] w-1/2 font-bold">
        ...
        <div className="imageContainer h-full absolute top-5 right-20">
